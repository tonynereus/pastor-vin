        ...
        useEffect(() => {
            ...
            fetch(apis.getAdminSample, {
                ...
                async (x) => {
                    ...
                    if(resu.city != undefined && resu.effect != undefined){
                        updatePage(true);
                        updateForm(
                            {
                                ...formParams,
                    ...
                    pageLoaded ? <>
                        ...
                        <div className="w-100 h-100 p-3 row m-0 justify-content-center">
                            <div className="col-md-9 col-11">
                                <div className="py-3 ">
                                    <svg onClick={()=>{enterWithData("sample",{})}} xmlns="http://www.w3.org/2000/svg" width="55" height="16" viewBox="0 0 55 16" fill="none">
                                ...
                                <div className="w-100 row m-0">
                                    <div className="col-md-6 p-0 m-0">
                                        <div className="w-100">
                                            <label htmlFor="" className="text-secondary" style={{ fontSize: 16, fontWeight: 500 }}>Sample Name</label>
                                            <input onChange={handleChange} value={formParams.substanceName} name="substanceName" className="form-control" placeholder="Sample Name" />
                                        </div>
                                        <div className="w-100">
                                            <label htmlFor="" className="text-secondary" style={{ fontSize: 16, fontWeight: 500 }}>City</label>
                                            <input onChange={handleChange} value={formParams.city} name="city" className="form-control" placeholder="City" />
                                        </div>
                                        <div className="w-100 mt-1">
                                            <label>Purchase Intent</label>
                                            <input onChange={handleChange} value={formParams.purchaseIntent} name="purchaseIntent" className="form-control" placeholder="Purchase Intent" />
                                        </div>
                                        <div className="w-100 mt-1">
                                            <label htmlFor="">Reported Effects</label>
                                            <input onChange={handleChange} value={formParams.effect} name="effect" className="form-control" placeholder="Reported Effects" />
                                        </div>
                                        <div className="w-100 mt-1">
                                            <label htmlFor="">Sample Colour</label>
                                            <input onChange={handleChange} value={formParams.sampleColor} name="sampleColor" className="form-control" placeholder="Sample Colour" />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="w-100 mt-1">
                                            <label htmlFor="">Sample Form</label>
                                            <input onChange={handleChange} value={formParams.sampleForm} name="sampleForm" className="form-control" placeholder="Sample Form" />
                                        </div>
                                        <div className="w-100 mt-1">
                                            <label htmlFor="">Consumption Method</label>
                                            <input onChange={handleChange} value={formParams.consumptionMethod} name="consumptionMethod" className="form-control" placeholder="Consumption Method" />
                                        </div>
                                        <div className="w-100 mt-1">
                                            <label htmlFor="">Notes</label>
                                            <input onChange={handleChange} value={formParams.notes} name="notes" className="form-control" placeholder="Add any notes" />
                                        </div>
                                        ...
                                        <div className="w-100 d-flex mt-2">
                                            ...
                                            <div className="w-50 p-3 d-flex px-2">
                                                <div className="btn bg-project-deep text-white w-100 py-2" onClick={handleSubmit}>Apply Changes</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
